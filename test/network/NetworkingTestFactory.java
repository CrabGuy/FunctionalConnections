...
/**
 * Factory for creating test instances of the Networking slice components (Slice E). Provides stub
 * implementations for unit testing RequestDispatcher.
 */
public class NetworkingTestFactory {
  ...
  public static class StubAccountService implements AccountService {
    ...
    @Override
    public AccountPrincipal resolve(String accountToken) {
      throw new UnsupportedOperationException();
    }
  }
  ...
  /**
   * Creates a RequestDispatcher wired with the given service implementations. Uses a dummy
   * InetSocketAddress and a stub GameClock.
   */
  public static RequestDispatcher createRequestDispatcher(
    ...
    return new RequestDispatcherImpl(
        accountService, proposalService, statsService, leaderboardService, new StubGameClock());
  }
}
