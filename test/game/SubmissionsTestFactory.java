...
/**
 * Factory for creating test instances of the Proposal submission & per-player game state components
 * (Slice C). Uses the real implementation classes from server.game.
 */
