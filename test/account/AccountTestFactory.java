...
/**
 * Factory for creating test instances of the account components. Centralises concrete class names
 * and configuration so that renames or constructor changes require updates only here.
 */
